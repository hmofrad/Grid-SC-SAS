 ...
 * ?Adaptive Cooperative Super Scheduling
 */
 ...
 */
class netuser10 extends GridUser
{
     ...
     *                   
     */
    netuser10(String name, double baud_rate, double delay, int MTU,int totalResource, ArrayList GFAList,
...
*/ 
        ...
        GFAAdjacency = extractGFAAdjacency(adjacencyMatrix, this.myGFAIndex_);
