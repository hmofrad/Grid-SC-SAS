...
*/            
            ...
            for (i = 0; i < num_user; i++)
            {
                ...
                netuser11 user = new netuser11("User_" + i, baud_rate, propDelay, mtu, totalResource, 
            ...
            netuser11 userObj = null;
            for (i = 0; i < userList.size(); i++)
            {
                // A First In First Out Scheduler is being used here.
                // SCFQScheduler can be used for more fairness
                FIFOScheduler userSched = new FIFOScheduler("netuser11Sched_"+i);
                userObj = (netuser11) userList.get(i);
